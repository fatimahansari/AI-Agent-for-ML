...
def validate_model(model_name: str, model_class, hyperparameters: dict, X, y, needs_scaling: bool, test_size: float = 0.2, problem_type: str = "regression"):
...
def main():
    ...
    try:
        # Configuration
        data_path = r"C:\Users\Administrator\OneDrive - Higher Education Commission\Desktop\IntelliModel\Reasoning Agent\..\Datasets\Housing.csv"
        target_column = "price"
        ...
        # Validate 1. Linear Regression with 80-20 split
        metrics_1_linear_regression = validate_model(
        ...
        validation_results.append(metrics_1_linear_regression)

        # Validate 3. Decision Tree Regressor with 80-20 split
        metrics_3_decision_tree_regressor = validate_model(
            model_name="3. Decision Tree Regressor",
        ...
        validation_results.append(metrics_3_decision_tree_regressor)
