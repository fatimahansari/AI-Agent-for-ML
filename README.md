...
The Master Orchestrator Agent maintains ultimate memory and context across all agents in the workflow. It coordinates and tracks outputs from:
...
python master_orchestrator.py \
  --csv "../Datasets/Housing.csv" \                                your datatset name
  --target "price" \                                               your target column
  --context "Real estate price prediction" \                       give your own context
  --test-size 0.2 \
  --min-models 1 \
  --max-models 3 \                                                 no of models you want the LLM to sugesst
  --save-memory
```
...
result = orchestrator.run_complete_workflow(
    csv_path=Path("../Datasets/dataset.csv"),
    target_column="target olumn",
    llm_context="give context",
    test_size=0.2,
    min_models=1,
    max_models=3,
